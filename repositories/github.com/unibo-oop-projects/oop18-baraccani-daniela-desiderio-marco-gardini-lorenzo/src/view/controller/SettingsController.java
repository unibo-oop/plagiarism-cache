...
/**
 * SettingsController to control Settings scene. It provides buttons for
 * regulating the sounds of the game. It uses items from javafx.
 */
public class SettingsController extends AbstractController implements Initializable {
     ...
     */
    public SettingsController(final ViewManager loader, final AudioManager audioManager) {
        super(loader);
