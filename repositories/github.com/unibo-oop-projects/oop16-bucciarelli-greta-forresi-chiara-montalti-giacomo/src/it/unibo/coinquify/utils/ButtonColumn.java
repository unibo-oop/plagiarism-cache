...
public class ButtonColumn extends AbstractCellEditor
     ...
     * 
     */
    private static final long serialVersionUID = -1107300391412266034L;
    ...
    /*
     * Implement ActionListener interface. The button has been pressed. Stop
     * editing and invoke the custom Action
     */
    @Override
    public void actionPerformed(final ActionEvent e) {
        ...
        // Invoke the Action
        final ActionEvent event = new ActionEvent(table, ActionEvent.ACTION_PERFORMED, String.valueOf(row));
        action.actionPerformed(event);
    }

    /*
     * Implement MouseListener interface When the mouse is pressed the editor is
     * invoked. If you then then drag the mouse to another cell before releasing
     * it, the editor is still active. Make sure editing is stopped when the
     * mouse is released.
     */
    @Override
