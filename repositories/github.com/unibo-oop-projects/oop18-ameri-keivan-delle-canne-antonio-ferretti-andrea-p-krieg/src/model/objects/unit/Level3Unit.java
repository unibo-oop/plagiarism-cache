...
/**
 * The Level3Unit class represents the third level unit. That unit is a
 ...
 */
public class Level3Unit extends UnitImpl {
    private static final UnitType TYPE = UnitType.CLOSE_NORMAL;
    private static final String NAME = "Spare Soldier";
    ...
    private static final int WOOD_COST = 120;
    private static final int POPULATION_COST = 2;
    private static final int UNLOCK_GOLD_COST = 300;
    private static final int UNLOCK_WOOD_COST = 300;
     ...
     */
    public Level3Unit(final Player owner) {
