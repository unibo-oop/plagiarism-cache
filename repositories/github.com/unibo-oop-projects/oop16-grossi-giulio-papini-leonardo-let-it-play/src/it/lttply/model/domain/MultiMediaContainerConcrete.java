...
/**
 * This class provides a container for one or more {@link MediaContainer}.
 * 
 * @param <T>
 *            the type of the elements stored
 */
public class MultiMediaContainerConcrete<T extends MediaContainer> implements MultiMediaContainer<T> {
    ...
    private final Optional<Set<T>> elements;
     ...
     * @param releaseDate
     *            the container's release date
     * @param physicalLocation
     *            the container's physical location (directory)
     * @param tags
     *            the container's {@link List} of tags
     * @param overview
     *            the container's overview
     * @param poster
     *            the container's poster
     * @param elements
     *            the container's {@link Set} of elements
     */
    protected MultiMediaContainerConcrete(final String id, final int size, final String title,
            final LocalDate releaseDate, final Path physicalLocation, final Optional<Map<String, String>> tags,
            final Optional<String> overview, final Optional<Picture> poster, final Optional<Set<T>> elements) {
        super();
        this.id = id;
        this.size = size;
        this.title = title;
    ...
    @Override
    public Optional<Set<T>> getElements() {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof MultiMediaContainerConcrete)) {
            return false;
        }
        final MultiMediaContainerConcrete<?> other = (MultiMediaContainerConcrete<?>) obj;
        if (elements == null) {
