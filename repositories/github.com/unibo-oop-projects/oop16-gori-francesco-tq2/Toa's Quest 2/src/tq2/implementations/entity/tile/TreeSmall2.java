 ...
 */
public class TreeSmall2 extends Tile {
	 ...
	 */
	public TreeSmall2 (Integer x, Integer y, Integer facing, Boolean solid, Boolean enabled, Double scaleX, Double scaleY, Float alpha, Handler handler, LevelLayer layer) {
		super(x, y, WIDTH, HEIGHT, facing, solid, enabled, scaleX, scaleY, 0.0, 0.0, alpha, handler, layer);
		
		this.id = Id.treeSmall2;
		...
		animations.put("Idle", spritesheets.get(SPRITESHEET).getAnim(149, 0, 149, 145, 0, 0, 1, 60, 0));
	}
	 ...
	 * @param layer the layer the object resides in
	 */
	public TreeSmall2 (Integer x, Integer y, Integer facing, Boolean solid, Boolean enabled, Integer width, Integer height, Float alpha, HandlerImpl handler, LevelLayer layer) {
	 ...
	 * @param layer the layer the object resides in
	 */
	public TreeSmall2 (Integer x, Integer y, Boolean solid, Handler handler, LevelLayer layer) {
