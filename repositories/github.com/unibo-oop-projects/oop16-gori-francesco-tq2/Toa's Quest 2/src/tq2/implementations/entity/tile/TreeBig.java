 ...
 */
public class TreeBig extends Tile {
		
	/** The width of the object. */
	protected static final Integer WIDTH = 214;
	 ...
	 */
	public TreeBig (Integer x, Integer y, Integer facing, Boolean solid, Boolean enabled, Double scaleX, Double scaleY, Float alpha, Handler handler, LevelLayer layer) {
		...
		animations.put("Idle", spritesheets.get(SPRITESHEET).getAnim(0, 145, 214, 240, 0, 0, 1, 60, 0));
	}
	 ...
	 * @param layer the layer the object resides in
	 */
	public TreeBig (Integer x, Integer y, Integer facing, Boolean solid, Boolean enabled, Integer width, Integer height, Float alpha, Handler handler, LevelLayer layer) {
	 ...
	 * @param layer the layer the object resides in
	 */
	public TreeBig (Integer x, Integer y, Boolean solid, Handler handler, LevelLayer layer) {
