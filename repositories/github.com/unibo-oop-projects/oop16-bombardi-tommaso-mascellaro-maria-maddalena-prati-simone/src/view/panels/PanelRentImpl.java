...
/**
 * 
 * panel rent impl class.
 *
 */
public class PanelRentImpl extends JPanel implements PanelRent {
    ...
    /**
     * panel rent impl constructor.
     */
    public PanelRentImpl() {
        super();
        ...
        final JLabel title = new JLabel("Scegli il prodotto che vuoi noleggiare");
