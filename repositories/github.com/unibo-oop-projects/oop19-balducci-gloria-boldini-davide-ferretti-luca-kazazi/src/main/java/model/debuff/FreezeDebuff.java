...
public class FreezeDebuff extends ActiveStaticObject implements DebuffInterface {

    private LimitedTimer limitedTimer;

    /**
     * Constructor for FreezeDebuff.
     * 
     * @param id
     * @param posX
     * @param posY
     * @param image
     */
    public FreezeDebuff(final ID id, final int posX, final int posY, final BufferedImage image) {
    ...
    public void effect(final Player player) { 
        ...
        this.limitedTimer = new LimitedTimer(player, ID.FREEZEDB);
