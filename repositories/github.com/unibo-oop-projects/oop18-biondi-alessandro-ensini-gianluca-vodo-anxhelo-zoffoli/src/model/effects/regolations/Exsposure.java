...
/**
 * Implementation of Regolation. Serves to adjust the exposure.
 */
public class Exsposure extends RegolationImpl {
    /**
     * 
     */
    private static final long serialVersionUID = 1L;
    private String effectName = "Exsposure";
    ...
    public Color changePixel(final Color source) {
        ...
        // change in intensity
        hsb[brightnessFlag] = hsb[brightnessFlag] >= 0.5f
                ? hsb[brightnessFlag] + hsb[brightnessFlag] * this.getIndex() / 100f
                : hsb[brightnessFlag] + hsb[brightnessFlag] * this.getIndex() / 100f;
        // control of value
