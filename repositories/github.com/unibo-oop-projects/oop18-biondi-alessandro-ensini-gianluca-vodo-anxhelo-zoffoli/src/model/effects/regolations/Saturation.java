...
/**
 * Implementation of Regolation. Serves to adjust the saturation.
 */
public class Saturation extends RegolationImpl {
    ...
    public Color changePixel(final Color source) {
        ...
        // change in intensity
        hsb[saturationFlag] = hsb[saturationFlag] + hsb[saturationFlag] * this.getIndex() / 100f;
        // control of value
        hsb[saturationFlag] = hsb[saturationFlag] > MAXINTENSITY ? MAXINTENSITY
                : hsb[saturationFlag] < MININTENSITY ? MININTENSITY : hsb[saturationFlag];
