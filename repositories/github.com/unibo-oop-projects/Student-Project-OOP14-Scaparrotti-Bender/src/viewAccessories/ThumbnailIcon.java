 ...
 * same dimensions.
 * <P>
 * If not set, the default size of <CODE>ThumbnailIcon</CODE> is 1/10 of the screen resolution.
 * 
 * ***Source: http://tips4java.wordpress.com/2012/04/14/thumbnail-icon/***
 *
...
/**
  ...
  private static int defaultWidth = (int) (screen.width * 0.1);
