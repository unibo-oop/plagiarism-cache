...
/**
 * An implementation of the {@link RandomAccessMemory} interface.
 * 
 * @author Manuel Bonarrigo
 *
 */
public final class RandomAccessMemoryImpl extends AbstractMemory implements RandomAccessMemory {

    /**
     * Constructs a {@link RandomAccessMemory} over the given informations.
     * 
     * @param device
     ...
     */
    public RandomAccessMemoryImpl(final GenericDevice device, final Integer capacity, final DigitalInformationUnit capacityUnit) {
    ...
    public boolean equals(final Object obj) {
        ...
        final RandomAccessMemoryImpl other = (RandomAccessMemoryImpl) obj;
        if (getCapacity() == null) {
    ...
    public String toString() {
        return "RandomAccessMemoryImpl [device=" + getGenericDevice() + ", capacity=" + getCapacity() 
