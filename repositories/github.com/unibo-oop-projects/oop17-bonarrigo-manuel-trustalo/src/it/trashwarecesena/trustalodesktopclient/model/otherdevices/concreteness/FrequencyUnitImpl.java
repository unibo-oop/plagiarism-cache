...
/**
 * An implementation of the {@link FrequencyUnit} interface.
 * 
 * @author Manuel Bonarrigo
 *
 */
public final class FrequencyUnitImpl implements FrequencyUnit {

    private final String name;

    /**
     * Constructs a {@link FrequencyUnit} with the given name.
     * 
     * @param name
     *            a String representing the name of the clock speed unit of measure.
     * 
     ...
     * 
     */
    public FrequencyUnitImpl(final String name) {
    ...
    public boolean equals(final Object obj) {
        ...
        final FrequencyUnitImpl other = (FrequencyUnitImpl) obj;
        if (name == null) {
            if (other.name != null) {
                return false;
            }
    ...
    public String toString() {
        return "FrequencyUnitImpl [name=" + name + "]";
    }
}
