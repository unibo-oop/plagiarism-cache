...
/**
 * A simple implementation of the {@link ContactCategory} interface. It is
 * backed up by a String.
 * 
 * @author Manuel Bonarrigo
 *
 */
public final class ContactCategoryImpl implements ContactCategory {

    private final String name;

    /**
     * Constructs a ContactCategoryImpl with the given name.
     * 
     * @param name
     ...
     */
    public ContactCategoryImpl(final String name) {
        super();
    ...
    @Override
    public int compareTo(final ContactCategory o) {
    ...
    public boolean equals(final Object obj) {
        ...
        final ContactCategoryImpl other = (ContactCategoryImpl) obj;
        if (name == null) {
            if (other.name != null) {
                return false;
            }
    ...
    public String toString() {
        return "ContactCategoryImpl [name=" + name + "]";
    }
