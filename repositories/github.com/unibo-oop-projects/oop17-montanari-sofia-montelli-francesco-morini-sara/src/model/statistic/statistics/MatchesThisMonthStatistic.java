...
/**
 * class representing the number of games played by a player this month.
 *
 */
public final class MatchesThisMonthStatistic extends AbstractStatistic<Integer> {
/**
 * the return value.
 */
 ...
 */
     public MatchesThisMonthStatistic(final List<StatisticMatch> matches) {
        super("Match played in this month");
        if (matches == null) {
