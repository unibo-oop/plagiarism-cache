 ...
 * @version 1.0
 */
public class ModificaLista extends JDialog {
	...
	/**
	 * Costruttore ModificaLista
	 * 
	 * @param view
	 * 				View
	 */
	public ModificaLista(ApplicationView view) {
		super(view);
	 ...
	 */
	public String getModificaLista(){
		return this.textField_ModificaLista.getText();
	}
}