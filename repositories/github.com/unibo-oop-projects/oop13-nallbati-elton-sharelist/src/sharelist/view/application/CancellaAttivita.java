 ...
 * @version 1.0
 */
public class CancellaAttivita extends JDialog {

	private static final long serialVersionUID = 134415416815440561L;
	private final JPanel contentPanel = new JPanel();
	private boolean okState = false;
	
	protected JTextField textField_CancellaAttivita;

	/**
	 * Costruttore CancellaAttivita
	 * 
	 * @param view
	 * 				View
	 */
	public CancellaAttivita(ApplicationView view) {
		super(view);
		setTitle("Cancella Attivita");
		...
		contentPanel.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		{
			...
			{
				JLabel lblSicuroDiVoler = new JLabel("Sicuro di voler cancellare l'attivita'?");
			...
			{
				textField_CancellaAttivita = new JTextField();
				textField_CancellaAttivita.setEnabled(false);
				textField_CancellaAttivita.setColumns(15);
				...
				data.add(textField_CancellaAttivita, gbc_textField_Nome);
				textField_CancellaAttivita.setColumns(15);
			}
		}
		{
	 ...
	 */
	public void reinit(){
		this.textField_CancellaAttivita.setText("");
	}
	
	/**
	 *  Ritorna il nome dell'attivita'
	 */
	public String getCancellaAttivita(){
		return this.textField_CancellaAttivita.getText();
	}
}