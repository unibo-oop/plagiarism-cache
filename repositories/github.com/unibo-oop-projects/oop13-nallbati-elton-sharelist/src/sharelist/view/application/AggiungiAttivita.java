...
/**
 * Registrazione di un'attivita'
 * 
 * @author Elton Nallbati
 * @version 1.0
 */
public class AggiungiAttivita extends JDialog {

	private static final long serialVersionUID = -4841570460463190105L;
	private final JPanel contentPanel = new JPanel();
	private boolean okState = false;
	
	private JTextField textField_NuovaAttivita;
	 ...
	 * 				View
	 */
	public AggiungiAttivita(ApplicationView view) {
		super(view);
		setTitle("Aggiungi Attivita'");
		...
		contentPanel.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		{
			...
			{
				textField_NuovaAttivita = new JTextField();
				textField_NuovaAttivita.setColumns(15);
				...
				data.add(textField_NuovaAttivita, gbc_textField_Nome);
				textField_NuovaAttivita.setColumns(15);
			}
		}
		{
	 ...
	 */
	public void reinit(){
		this.textField_NuovaAttivita.setText("");
	}
	
	/**
	 *  Ritorna nome nuova attivita'
	 */
	public String getNuovaAttivita(){
		return this.textField_NuovaAttivita.getText();
	}
}