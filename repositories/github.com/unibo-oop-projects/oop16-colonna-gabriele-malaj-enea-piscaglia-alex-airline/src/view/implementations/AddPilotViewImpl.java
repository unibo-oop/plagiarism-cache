...
public class AddPilotViewImpl implements AddPilotView {
	...
	private JLabel lblIdLicenzaVolo;
	private JLabel lblFiscalCode;
	private JTextField txfFiscalCode;
	private JTextField txfLicenseID;
	...
	private void initializeComponents() {
		...
		txfLicenseID = new JTextField(MAX_CHARACTERS);
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
									...
									.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
										...
										.addComponent(lblIdLicenzaVolo))
									.addPreferredGap(ComponentPlacement.RELATED)
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
										.addComponent(txfLicenseID, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								...
								.addGroup(groupLayout.createSequentialGroup()
									.addComponent(cmbxDay, GroupLayout.PREFERRED_SIZE, 41, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(cmbxMonth, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
	...
	public String getPilotLicenseId() {
		return txfLicenseID.getText();
	}

	public String getPilotBirthDate() {
