...
import gymman.fitness.AbstractMetric;
...
public abstract class AbstractModifyProgramController implements Controller {
    ...
    @Getter @Setter private TrainingProgramRepository trainingProgramRepo;
    ...
    private static int subscriptionDuration = 0;
    ...
    /** view labels. */
    @FXML protected Label nameLabel, contactLabel, typeLabel, instructorLabel, durationLabel, secondsLabel, repetitionLabel, exSizeLabel;
    /** view text fields. */
     ...
     */
    public AbstractModifyProgramController(final NavigationService nav, final TrainingProgramRepository trainingProgramRepo) {
        this.nav = nav;
    ...
    public void addExercise() {
        ...
        if (!areExerciseFieldsSelected()) {
            ...
            final AbstractMetric exerciseMetric;
    ...
    public void hideOnSelectedMetric() {
        if (this.metricCombo.getValue() != null && this.metricCombo.getValue().equals(WITH_TIMER)) {
            ...
            this.repetitionLabel.setVisible(true);
