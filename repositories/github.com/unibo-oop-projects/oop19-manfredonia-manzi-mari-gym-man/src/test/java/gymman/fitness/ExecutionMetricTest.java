...
public class ExecutionMetricTest {
    ...
    private final AbstractMetric timerMetric = new MetricWithTimer(10, 10);
    /** repetitionMetric field. Execution method with timer repetitions */
    private final AbstractMetric repetitionMetric = new MetricWithRepetitions(10, 10);
    ...
    public void illegalTimerMetricParametersTest() {
        ...
        final AbstractMetric timerMetric = new MetricWithTimer(0, 0);
    }
    ...
    public void illegalRepetitionsMetricParametersTest() {
        ...
        final AbstractMetric repetitionsMetric = new MetricWithRepetitions(0, 0);
    }
}
