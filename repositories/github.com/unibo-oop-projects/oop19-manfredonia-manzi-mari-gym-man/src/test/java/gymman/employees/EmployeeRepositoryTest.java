...
public class EmployeeRepositoryTest {
    ...
    public void testErrorWhenAddingEntityWithSameFiscalCode()
        ...
        Employee empl = Employee.builder().username("pippo").firstname("pippo").lastname("pippo").fiscalCode("abcppp00a00a000a").role("ROLE_1").build();
        Employee empl2 = Employee.builder().username("pluto").firstname("pluto").lastname("pluto").fiscalCode("abcppp00a00a000a").role("ROLE_1").build();
    ...
    public void testErrorWhenAddingEntityWithSameUsername()
            throws DuplicateEntityException {
        Employee empl = Employee.builder().firstname("pippo").lastname("pippo").fiscalCode("pppppp00a00a000a").username("abc").role("ROLE_1").build();
        Employee empl2 = Employee.builder().firstname("pluto").lastname("pluto").fiscalCode("pltppp00a00a000a").username("abc").role("ROLE_1").build();
    ...
    public void testSearchByName() throws DuplicateEntityException {
        Employee empl = Employee.builder().username("pippo").firstname("pippo").lastname("foo").fiscalCode("abcppp00a00a000a").role("ROLE_1").build();
        Employee empl2 = Employee.builder().username("pluto").firstname("pluto").lastname("bar").fiscalCode("defppp00a00a000a").role("ROLE_1").build();
    ...
    public void testGetByUsernameReturnsEmptyOptionalWhenNotFound() {
        Optional<Employee> employee = this.repo.getEmployeeByUsername("pippo");
    ...
    public void testCanGetEmployeeByUsername() {
        ...
        Optional<Employee> res = this.repo.getEmployeeByUsername(empl.getUsername());
