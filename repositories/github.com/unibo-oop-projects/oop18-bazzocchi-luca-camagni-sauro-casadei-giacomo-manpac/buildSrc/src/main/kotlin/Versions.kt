...
object Versions {
    ...
    const val de_aaschmid_cpd_gradle_plugin: String = "2.0"

    const val checkstyle: String = "8.17"

    const val pmd_dist: String = "6.13.0"

    const val pmd_java: String = "6.15.0"

    const val spotbugs: String = "3.1.10"
