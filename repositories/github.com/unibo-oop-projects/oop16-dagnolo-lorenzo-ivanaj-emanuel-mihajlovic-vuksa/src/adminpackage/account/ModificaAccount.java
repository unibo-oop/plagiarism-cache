    ...
    public ModificaAccount() {
        ...
        this.conferma.addActionListener(a -> {
            ...
            if (risp == JOptionPane.YES_OPTION) {
                ...
                if (opt.isPresent()) {
                    JOptionPane.showMessageDialog(frame, "Password modificata con successo da " + opt.get() + "!");
        ...
        this.esci.addActionListener(f -> {
            int risp = JOptionPane.showConfirmDialog(this.frame, "Vuoi uscire ?", "Conferma", JOptionPane.YES_OPTION);
            if (risp == JOptionPane.YES_OPTION) {
                this.frame.setVisible(false);
                new Scelte();
                }
