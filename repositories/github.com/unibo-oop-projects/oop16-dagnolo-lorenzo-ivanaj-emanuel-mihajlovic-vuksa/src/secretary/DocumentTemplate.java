...
public abstract class DocumentTemplate {
    ...
    public abstract void nextOperations();
    
    public DocumentTemplate(final String testo){
        this.frame = new JFrame(testo);
        ...
        this.conferma.addActionListener(e -> {
            if (this.text.getText().length() == 0) {
                ...
                int risp = JOptionPane.showConfirmDialog(this.frame, "Sei sicuro di voler procedere?",
