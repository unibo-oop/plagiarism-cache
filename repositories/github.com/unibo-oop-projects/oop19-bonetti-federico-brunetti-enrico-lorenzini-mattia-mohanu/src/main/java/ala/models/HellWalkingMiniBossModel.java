...
/**
 * HellWalkingMiniBossModel class.
 * 
 */
public class HellWalkingMiniBossModel extends HellWalkingEnemyModel {
     ...
     * 
     */
    public HellWalkingMiniBossModel(final double x, final double y) {
