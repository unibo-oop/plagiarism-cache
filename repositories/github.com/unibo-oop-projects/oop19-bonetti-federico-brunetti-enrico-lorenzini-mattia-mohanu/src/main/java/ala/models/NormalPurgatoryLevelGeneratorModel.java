...
/**
 * NormalPurgatoryLevelGeneratorModel class.
 * 
 */
public class NormalPurgatoryLevelGeneratorModel extends LevelGeneratorPatternModel {
    ...
    private static final int PURGATORY_LVL_TYPE = 2;
     ...
     * 
     */
    public NormalPurgatoryLevelGeneratorModel(final LVLNUMBER lvlNumber) { //Load game Level resources:
        super(lvlNumber, PURGATORY_LVL_TYPE);
