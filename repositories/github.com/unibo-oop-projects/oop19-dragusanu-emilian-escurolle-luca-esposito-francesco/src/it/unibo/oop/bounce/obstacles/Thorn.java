...
public class Thorn implements Obstacles {
	
	private Fixture fixture;
	private static final int TYPE = 6;

	public Thorn(final PlayScreen playscreen, final float x, final float y, final MapObject rObject) {
		TypeDefinerImpl typeDef = new TypeDefinerImpl(playscreen, x, y, rObject);
		typeDef.setEntity(1, TYPE);
		typeDef.setCategoryFilter(Manager.THORN_ID);
