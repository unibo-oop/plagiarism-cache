 ...
 */
public final class Terrain extends AbstractBehaviourDecorator {
    @Serial
     ...
     */
    public Terrain(final MoveBehaviour base, final Optional<JsonObject> values) {
        super(base);
     ...
     * 
     * @param base The Behaviour to Decorate.
     * @param toCopy An old instance of {@link Terrain} to take the values from.
     */
    public Terrain(final MoveBehaviour base, final Terrain toCopy) {
        super(base);
    }
