...
/**
 * Special Behaviour exclusive to the {@link Move} "Uproar".
 */
public final class Uproar extends AbstractBehaviourDecorator {
    @Serial
    private static final long serialVersionUID = 1L;

    private final String removeCondition;
     ...
     */
    public Uproar(final MoveBehaviour base, final Optional<JsonObject> values) {
        super(base);
        this.removeCondition = "sleep";
     ...
     * 
     * @param base The Behaviour to Decorate.
     * @param toCopy An old instance of {@link Uproar} to take the values from.
     */
    public Uproar(final MoveBehaviour base, final Uproar toCopy) {
        super(base);
        this.removeCondition = toCopy.removeCondition;
    }
