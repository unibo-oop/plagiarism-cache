...
/**
 * This command allow at the spaceship to stop down.
 */
public class StopDown extends AbstractHandler implements Command {

    private final CommandType commandType = CommandType.STOP_DOWN;
     ...
     */
    public StopDown(final KeyInput keyInput) {
        super(keyInput);
    }
    ...
    protected final List<Optional<Command>> doOperation() {
        ...
        keyInput.deleteCommand(new MoveDown(keyInput));
    ...
    public final boolean equals(final Object obj) {
        if (obj instanceof StopDown) {
            final StopDown other = (StopDown) obj;
