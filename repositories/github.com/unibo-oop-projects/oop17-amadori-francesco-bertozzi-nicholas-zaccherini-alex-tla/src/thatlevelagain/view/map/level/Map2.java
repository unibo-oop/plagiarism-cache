 ...
 *
 */
public class Map2 extends MapImpl implements Runnable {

    private static final int ACTUAL_LEVEL = 2;
    private static final int NEXT_STATE = GameStateManagerImpl.LEVEL3;
    private boolean go;
     ...
     *         actual manager.
     */
    public Map2(final GameStateManagerImpl manager) {
    ...
    public void nextLevel() {
        th.start();
        this.getManager().getStates().add(new Level3(this.getManager()));
        this.go = true;
    }
    @Override
