 ...
 *
 */
public class Map3 extends MapImpl implements Runnable {

    private static final int ACTUAL_LEVEL = 3;
    private static final int NEXT_STATE = GameStateManagerImpl.LEVEL4;
    private boolean go;
    ...
    public void nextLevel() {
        th.start();
        this.getManager().getStates().add(new Level4(this.getManager()));
        this.go = true;
    }
    @Override
