...
public class RoleRepositoryTest {
	...
	public void testCanAddRole() {
		Role role = new Role.Builder("foo").withId("123").build();
		try {
			this.repo.add(role);
	...
	public void testPreventAddingDuplicate() throws DuplicateEntityException {
		Role a = new Role.Builder("foo").withId("123").build();
		Role b = new Role.Builder("foo").withId("456").build();
	...
	public void testCanGetExistingRoleByName() throws DuplicateEntityException {
		Role role = new Role.Builder("foo").build();
		this.repo.add(role);
