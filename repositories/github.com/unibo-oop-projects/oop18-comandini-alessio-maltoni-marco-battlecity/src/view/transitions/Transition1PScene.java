...
/**
 * Scene class for the transition between Main Menu and One Player Mode. The
 * class extends JavaFX's class Scene.
 */
public final class Transition1PScene extends Scene implements GameSceneInterface {
    ...
    private static final String MODE = "ONE PLAYER MODE";
     ...
     */
    public Transition1PScene(final Controller controller) {
