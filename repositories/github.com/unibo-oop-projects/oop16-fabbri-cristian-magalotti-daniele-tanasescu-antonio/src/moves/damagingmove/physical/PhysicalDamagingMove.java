...
public abstract class PhysicalDamagingMove extends moves.damagingmove.DamagingMove{

    public PhysicalDamagingMove(String name, String description, int moveBasePower, Type moveType, double moveAccuracy,
            double actualCritRange, int maxPP, int priority) {
        super(name, description, moveBasePower, moveType, moveAccuracy, actualCritRange, maxPP, priority);
        this.setMakingContact(true);
    }
