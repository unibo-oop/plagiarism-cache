...
public class Overgrow extends HPConditionAbility{

    public Overgrow() {
        super(  "Overgrow",                                                                                //name 
                "Powers up Grass-type moves when the Pokemon's HP is low.",                              //description 
                0.33);                                                                                  //hpBound
    }
    ...
    public void activateAbility(Pokemon user, Pokemon target, BattleArena battleArena) {
        for(Move move : user.getAllMoves()){
            if(move instanceof DamagingMove && move.getMoveType().equals(new Grass())){
