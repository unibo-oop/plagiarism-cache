...
public class RainDish extends WeatherConditionAbility{

    public RainDish() {
        super(  "Rain Dish",                                                               //name 
                "The Pokemon gradually regains HP in rain.",                               //description
    ...
    public void activateAbility(Pokemon user, Pokemon target, BattleArena battleArena) {
        if(user.getHp() > user.getMaxHp()){
            ...
            user.takeDamage(-user.getMaxHp()/16, false);                                           //heals the Pokemon of 1/16 of its max HP
        }
